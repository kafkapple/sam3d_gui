...
class FlexiCubes:
    ...
    def _compute_reg_loss(self, vd, ue, edge_group_to_vd, vd_num_edges):
        ...
        mean_l2 = (mean_l2).index_add_(0, edge_group_to_vd, dist.to(mean_l2.dtype)) / vd_num_edges.squeeze(1).float()
    ...
    def _compute_vd(self, voxelgrid_vertices, surf_cubes_fx8, surf_edges, scalar_field,
        ...
        vd = vd.index_add_(0, index=edge_group_to_vd, source=(ue_group * beta_group).to(vd.dtype)) / beta_sum
        ...
        if voxelgrid_colors is not None:
            ...
            vd_color = vd_color.index_add_(0, index=edge_group_to_vd, source=(uc_group * beta_group).to(vd_color.dtype)) / beta_sum
        else:
            vd_color = None
